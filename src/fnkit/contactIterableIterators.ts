...
export function concat<T, U, V>(
  ii1: IterableIterator<T>,
  ii2: IterableIterator<U>,
  ii3: IterableIterator<V>,
): IterableIterator<T | U | V>
export function concat<T, U, V, W>(
  ii1: IterableIterator<T>,
  ii2: IterableIterator<U>,
  ii3: IterableIterator<V>,
  ii4: IterableIterator<W>,
): IterableIterator<T | U | V | W>
export function concat<T, U, V, W, X>(
  ii1: IterableIterator<T>,
  ii2: IterableIterator<U>,
  ii3: IterableIterator<V>,
  ii4: IterableIterator<W>,
...
export function concat(...iis: IterableIterator<any>[]): IterableIterator<any> {
  return (function* () {
    for (const ii of iis) {
